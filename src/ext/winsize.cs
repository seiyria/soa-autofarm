...
public class Startup
{
  ...
  public async Task<object> Invoke(Object[] nwh)
  {
    FindWindowsWithText((string)nwh[0]).ToList().ForEach(w => {
      Rect bounds = WindowBounds(w);
      
      MoveWindow(w, bounds.Left, bounds.Top, (int)nwh[1], (int)nwh[2], true);
    });
